            ...
            {'microserviceA':
                {
                    'parameters':
                        [
                                    {
                                        'name':'microserviceAn1', 'type':'int','mandatory': True,
                                        'defaultValue':'45','description':'microserviceAsample n1'
                                     },
                                    {
                                        'name':'microserviceAn2', 'type':'bool','mandatory': False,
                                        'defaultValue':'45','description':'microserviceAsample n2'
                                    }
                        ]
                }
            },
            {'microserviceB':
                {
                    'parameters':
                        [
                                    {
                                        'name':'microserviceBn1', 'type':'int','mandatory': True,
                                        'defaultValue':'45','description':'microserviceBsample n1'
                                     },
                                    {
                                        'name':'microserviceBn2', 'type':'bool','mandatory': False,
                                        'defaultValue':'45','description':'microserviceBsample n2'
                                    }
                        ]
                }
            },
            {'microserviceC':
                {
                    'parameters':
                        [
                            {
                                'name': 'microserviceCn1', 'type': 'int', 'mandatory': True,
                                'defaultValue': '45', 'description': 'microserviceBsample n1'
                            },
                            {
                                'name': 'microserviceBn2', 'type': 'bool', 'mandatory': False,
                                'defaultValue': '45', 'description': 'microserviceCsample n2'
                            }
                        ]
                }
            },
